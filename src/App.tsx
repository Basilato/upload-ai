...
export function App() {
  ...
  return (
     ...
     <main className="flex-1 p-6 flex gap-6" > 
      <div className="flex flex-col flex-1 gap-4 " >
        <div className="grid grid-rows-2 gap-4 flex-1" >
          <Textarea placeholder="Inclua o prompt para IA..." 
        ...
        <p className="text-sm text-muted-foreground " >Lembre-se: voce pode utilizar a variável <code className="text-violet-400" >{"{transcription}"} </code>no seu prompt para adicionar o conteúdo da transcrição do video selecionado</p>
      </div>
      ...
      <form className="space-y-6 ">
        ...
        <div className="space-y-2" >
          ...
          <Textarea id="transcription_prompt" className="h-20 leading-relaxed resize-none " placeholder="Inclua palavras-chave mencionadas no video separadas por virgula (,)" ></Textarea>
        </div>
    ...
    <div className="space-y-2" > 
      ...
      type="submit"
    className="w-full"
      > Executar <Wand2 className=" w-4 h-4 ml-2 " /> </Button>
